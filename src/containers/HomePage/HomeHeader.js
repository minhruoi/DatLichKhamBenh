                    ...
                    <div className="home-header-content">
                        ...
                        <div className='center-content'>
                            <div className='child-content'>
                                ...
                                <div className='sub-title'><FormattedMessage id="home-header.search-placeholder" /></div>
                            </div>
                            <div className='child-content'>
                ...
                <div className="home-header-banner">
                    <div className='content-up'>
                        ...
                        <div className='search'>
                            ...
                            <FormattedMessage id="banner.search-placeholder" defaultMessage="Tìm kiếm dịch vụ y tế">
                                {(placeholder) => (
                    ...
                    <div className='content-down'>
                        <div className='options'>
                            ...
                            <div className='option-child'>
                                <div className='icon-child'><i class="fas fa-child"></i></div>
